...
test('TC_LL01: Verify that the user can search for locations on “ĐIỂM THANH TOÁN” tab', async ({ page }) => {
...
test('TC_LL02: Verify that the user can search for locations on “ĐIỂM GIẢI NGÂN” tab', async ({ page }) => {
    const waitFunction = new WaitFunction(page);
...
test('TC_LL03: Verify that the user can search for locations on “ĐIỂM GIỚI THIỆU DỊCH VỤ” tab', async ({ page }) => {
    const waitFunction = new WaitFunction(page);
