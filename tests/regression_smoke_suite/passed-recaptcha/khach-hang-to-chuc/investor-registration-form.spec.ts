...
test.only('TC_IRF01: Verify that the user can successfully submit the form – VN site', async ({ page }) => {
...
test.only('TC_IRF02: Verify that the user can successfully submit the form – EN site', async ({ page }) => {
