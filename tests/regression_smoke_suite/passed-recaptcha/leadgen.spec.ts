...
test.skip(`Verify duplication prevention`, async ({ page }) => {
    await test.step('Access LeadGen form', async () => {
        await page.goto('./');
        await page.waitForLoadState('domcontentloaded');
    })
...
test.skip(`Verify happy case with PL product allocated to vTiger`, async ({ page }) => {
    await test.step('Access LeadGen form', async () => {
        await page.goto('./');
        await page.waitForLoadState('domcontentloaded');
    })
...
test.skip(`Verify happy case with PL product allocated to iSale`, async ({ page }) => {
    await test.step('Access LeadGen form', async () => {
        await page.goto('./');
        await page.waitForLoadState('domcontentloaded');
    })
...
test.skip(`Verify happy case with CRC product allocated to iSale`, async ({ page }) => {
    await test.step('Access LeadGen form', async () => {
        await page.goto('./');
        await page.waitForLoadState('domcontentloaded');
    })
...
test.skip(`Verify happy case with TWL product allocated to iSale`, async ({ page }) => {
    await test.step('Access LeadGen form', async () => {
        await page.goto('./');
        await page.waitForLoadState('domcontentloaded');
    })
...
test.skip(`Verify happy case with CDL product allocated to iSale`, async ({ page }) => {
    await test.step('Access LeadGen form', async () => {
        await page.goto('./');
        await page.waitForLoadState('domcontentloaded');
    })
...
test.skip(`Verify PL product notification to XSTU`, async ({ page }, testInfo) => {
    await test.step('Access LeadGen form', async () => {
        await page.goto('./');
        await page.waitForLoadState('domcontentloaded');
    })
