...
Array.from({ length: 1 /* number of times to run the test */ }).forEach((_, index) => {
    ...
    test(`TC_LoadTest_01: Verify happy case with PL product allocated to vTiger - #${index + 1}`, async ({ page }) => {
    ...
    test(`TC_LoadTest_02: Verify happy case with PL product allocated to iSale - #${index + 1}`, async ({ page }) => {
        await test.step('Access LeadGen form', async () => {
            await page.goto('./');
            await page.waitForLoadState('domcontentloaded');
        })
    ...
    test(`TC_LoadTest_03: Verify happy case for VNPAY repayment - #${index + 1}`, async ({ page }) => {
    ...
    test(`TC_LoadTest_04: Verify failed case for VNPAY repayment - #${index + 1}`, async ({ page }) => {
        await test.step('Access VNPAY form', async () => {
            await page.goto('./thanh-toan-truc-tuyen/');
            await page.waitForLoadState('domcontentloaded');
            await page.locator('#repayment-vnpay-tab').click();
    ...
    test(`TC_LoadTest_05: Verify happy case with CRC product allocated to iSale - #${index + 1}`, async ({ page }) => {
        await test.step('Access LeadGen form', async () => {
            await page.goto('./');
            await page.waitForLoadState('domcontentloaded');
        })
    ...
    test(`TC_LoadTest_06: Verify happy case with TWL product allocated to iSale - #${index + 1}`, async ({ page }) => {
        await test.step('Access LeadGen form', async () => {
            await page.goto('./');
            await page.waitForLoadState('domcontentloaded');
        })
    ...
    test(`TC_LoadTest_07: Verify happy case with CDL product allocated to iSale - #${index + 1}`, async ({ page }) => {
        await test.step('Access LeadGen form', async () => {
            await page.goto('./');
            await page.waitForLoadState('domcontentloaded');
        })
